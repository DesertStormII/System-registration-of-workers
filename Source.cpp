...
int main()
{
    ...
    while (command != 5) {
        system("CLS");
        cout << endl;
        cout << "\t Write anything for continue(numbers)." << endl;
        ...
        while (exit1 != 0) {
            if (command == 1) {
                ...
                if (age < 18)
                    ...
                    if (work == 1) {
                        ...
                        if (TypeSalary == 2 || TypeSalary == 1) {
                            cout << "\t Allright!We are waiting for you tomorrow at 8:15. For the firs time."<<endl;
                        }
                        else {
                ...
                cout << endl <<"\t Write 0 for exit." << endl << "   \t";
                cin >> exit1;
            }
            else if (command == 3) {
                system("CLS");
